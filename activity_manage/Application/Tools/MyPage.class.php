...
namespace Tools;
use Think\Page;
// Tools名称与上级目录名称一致,该类文件在做自动加载的时候,Tools名称会转化为目录的一部分,进而include引入当前文件夹
class MyPage extends Page {
		...
		public function __construct($total, $listRows=10, $pa=""){
			...
			$this->firstRow=($this->page-1)*($this->listRows);
		}
