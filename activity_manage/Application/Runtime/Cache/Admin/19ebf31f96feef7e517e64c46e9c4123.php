    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <form class="form-horizontal" role="form" action="/studentWeb-master/Public/index.php/Admin/Delall/bdelunit" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <span><?php echo $v['unitname'];?></span></td>
                        </td>
                        <td><span><?php echo $v['unitinfo'];?></span></td>
                        <td><span><a href="/studentWeb-master/Public/Public/<?php echo ($v['cehua']); ?>"><?php echo ($v['cehuaname']); ?></a></span></td>
                        <td><span><?php echo $v['createtime'];?></span></td>
                        <td>
                            <a onclick="return confirm('是否确认删除')" href="/studentWeb-master/Public/index.php/Admin/Delall/delunit?id=<?php echo $v['id'];?>"><span><i class='icon-remove'></i> 删&nbsp;&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
