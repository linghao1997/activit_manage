        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td><?php $sum = $v['goodsnum']*$v['goodsprice']; echo $sum;?></td>
                    <td> <?php
 echo "<a onclick=\"return confirm('是否确认删除')\" href='/activity_manage/Public/index.php/Admin/Notice/del?id=".$v['id']."'>删 除</a>";echo '&nbsp;'; echo "<a href='./goodsEdit?id=".$v['id']."'>修 改</a>"; ?></td>
                </tr>
                <?php endforeach;?>
