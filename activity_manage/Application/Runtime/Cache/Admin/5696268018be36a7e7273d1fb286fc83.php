...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/applyback/newApply"> &nbsp;申请回复</a><span>|</span><a href="/index.php/admin/applyback/editApply?id=32" class="current"> 申请处理</a> </div>
        <h1>申请 处理</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="/Public/<?php echo ($data[0]['adminpicthumb']); ?>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width:20%;">申请人自述:</td>
                        <td><?php echo ($data[0]['instruction']); ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">申请的社团:</td>
                        <td><?php echo ($data[0]['unitname']); ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">申请&nbsp;&nbsp;状态:</td>
                        <td><?php
 if($data[0]['status']==0){ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; }elseif($data[0]['status']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($data[0]['status']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">申请&nbsp;&nbsp;时间:</td>
                        <td><?php echo ($data[0]['createtime']); ?></td>
                    </tr>
                    <form method="post" action="/index.php/admin/applyback/editApply?id=32">
                    <tr>
                    ...
                    <tr>
                        <input type="hidden" name="adminid" value="<?php echo ($data[0]['adminid']); ?>"></input>
                    <input type="hidden" name="status" id="status" value="0"></input><input type="hidden" name="id" value="<?php echo ($data[0]['id']); ?>"></input>
                        <td colspan="2">
                            <?php
 if($data[0]['status']==0){ echo '<button type="submit" onclick="return c1()" class="btn btn-danger">同意&nbsp;&nbsp;申请</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" onclick="return c2()" class="btn btn-warning">不同意&nbsp;&nbsp;申请</button>&nbsp;&nbsp;&nbsp;&nbsp;'; } ?>&nbsp;&nbsp;&nbsp;&nbsp;</form><a href="/index.php/admin/applyback/newApply" ><button class="btn btn-info">返&nbsp;&nbsp;回</button></a> 
                    </tr>
