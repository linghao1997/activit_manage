            ...
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th style="text-align: left;" colspan="8">
                        ...
                        <span>通知草稿箱</span>
                        <span style="float: right;"><a href="/studentWeb-master/Public/index.php/Admin/Notice/handleNotice">
                ...
                <form class="form-horizontal" role="form" action="/studentWeb-master/Public/index.php/Admin/Notice/bdel" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <span><img src="/studentWeb-master/Public/Public/<?php echo ($v['newpic']); ?>"></span></td>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="/studentWeb-master/Public/index.php/Admin/Notice/edit?id=<?php echo $v['id'];?>"><span>处&nbsp;理</span></a>&nbsp;&nbsp;
                            <a onclick="return confirm('是否确认删除')" href="/studentWeb-master/Public/index.php/Admin/Notice/del?id=<?php echo $v['id'];?>"><span>删&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
