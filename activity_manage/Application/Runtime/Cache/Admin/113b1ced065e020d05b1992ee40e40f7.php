...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/student/changeData"> 学生平台</a><span>|</span><a href="/index.php/admin/Student/usedActivity" class="current"> 查看参与的活动</a> </div>
        <h1>学生平台 查看参与活动</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
 ...
 if(!empty($kon)){ echo "<tr>
                <td style='width:20%; text-align: center;' colspan='2'><span4>$kon</span4></td>
                    ...
                    <?php foreach($data as $k=>$v):?>
                        <tr>
                            <td style="width:20%;" colspan="2"><span3>我参加的第<?php echo ($k+1); ?>个活动:</span3></td>
                        </tr>
                        <tr>
