...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="/activity_manage/Public/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/activity_manage/Public/index.php/Admin/Notice/userInfo"> 参加活动用户信息</a><span>|</span><a href="/activity_manage/Public/index.php/Admin/Notice/userInfo" class="current">参加活动用户信息</a> </div>
        <h1>参加活动用户信息</h1>
        <div id="search">
            <form class="form-horizontal" role="form" action="/activity_manage/Public/index.php/Admin/Notice/search" method="get">
                <input type="text" class="form-control" name="searchname" placeholder="搜索联系人">
            ...
            <table class="table table-bordered table-striped">
                ...
                <form class="form-horizontal" role="form" action="" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <span ><a href="attendActivity.html?id=<?php echo ($v['id']); ?>">查看参加活动情况</a></span></td>
                        </td>
