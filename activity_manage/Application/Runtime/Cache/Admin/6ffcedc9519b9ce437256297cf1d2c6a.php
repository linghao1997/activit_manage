...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/activity/activityData"> 举办活动</a><span>|</span><a href="/index.php/admin/Activity/activityStatus" class="current"> 活动状态</a> </div>
        <h1>活动  状态</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        ...
        <form class="form-horizontal" role="form" action="/index.php/admin/Activity/activityStatus" method="post">
 ...
 if($v['status']== 1){ echo "<span><i class='icon-lock'></i> 活动已结束</span>"; }elseif($v['status']== 0){ echo "<span><i class='icon-group'></i> 活动进行中</span>"; } ?>
                            ...
                            <td>
                                <?php
 if($v['status'] == 0 ){ echo "<a href=\"/index.php/admin/activity/change?id=".$v['id']."\"  onclick=\"return confirm('是否修改活动状态为结束?')\">修 改</a>"; }else{ echo '&nbsp;'; } ?>
                            </td>
                        </tr>
                    <?php endforeach;?>
