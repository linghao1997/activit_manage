...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/Teacher/changeData"> 教师平台</a><span>|</span><a href="/index.php/admin/Teacher/changeData" class="current"> 修改教师资料</a> </div>
        <h1>教师 修改个人资料</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 400px;">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 0">
                    ...
                    <tbody>
                        <form class="form-horizontal" role="form" action="/index.php/admin/teacher/changeData" method="post">
                        <tr>
                            <td style="text-align: center;width: 15%;">
                                <span3>教师工号:&nbsp;&nbsp;</span3>
                            </td><td>
                            <input type="text" class="form-control col-md-9" name="num" value="<?php echo ($data['num']); ?>" placeholder="教师工号" disabled>
                        ...
                        <tr>
                            ...
                            <input type="text" class="form-control col-md-9" name="username" id="cg2" onchange="return c2()" value="<?php echo ($data['username']); ?>" placeholder="教师昵称">
                                <span2 id="sp2"></span2>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control col-md-9" id="cg5" name="info" value="<?php echo ($data['info']); ?>" placeholder="教师具体信息">
                                <span2 id="sp5"></span2>
                            </td>
                        </tr>
                        <tr>
