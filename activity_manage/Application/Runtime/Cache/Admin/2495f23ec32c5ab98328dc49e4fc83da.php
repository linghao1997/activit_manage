...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Apply/createUnit"> &nbsp;我的申请</a><span>|</span><a href="/index.php/Admin/Apply/applyStatus" class="current"> 申请状态</a> </div>
        <h1>我的  申请</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
                ...
                <tr>
                    ...
                    <?php foreach($data as $k=>$v):?>
                        <tr>
                            ...
                            <td><textarea rows="6"><?php echo ($v['teachersay']); ?></textarea></td>
                            <td> 
                            <?php
 if($v['status']==0){ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; }elseif($v['status']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['status']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?>
                            ...
                            <td>
                                <?php
 if($v['status']!==1){ echo "<a onclick=\"return confirm('是否确认删除')\" href='/index.php/Admin/Apply/del?id=".$v['id']."'>删 除</a>"; }else{ echo '&nbsp;'; } ?>
                            </td>
                        </tr>
                    <?php endforeach;?>
