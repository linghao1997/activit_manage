...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Activity/activityData"> 举办活动</a><span>|</span><a href="/index.php/Admin/Activity/edit?id=6" class="current"> 上传活动总结</a> </div>
        <h1>上传  活动  总结</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        ...
        <form class="form-horizontal" role="form" action="/index.php/Admin/Activity/edit?id=6" method="post">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo ($data[0]['activename']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width:20%;">活动状态:</td>
                        <td><span>活动已结束</span></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">举办社团:</td>
                        <td><?php echo ($data[0]['unitname']); ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">活动类型:</td>
                        <td><?php echo ($data[0]['classifyname']); ?></td>
                    </tr>
