    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 400px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped" style="border: 0">
                ...
                <tbody>
                <form class="form-horizontal" role="form" action="/activity_manage/Public/index.php/Admin/Notice/capital.html?id=20" method="post" ENCTYPE="multipart/form-data">
                    <tr>
                        <td>活动名称:</td>
                        <td>
                            <select id="s1" class="form-control" name="activeid">
                                <?php foreach($data as $k=>$v):?>
                                <option value="<?php echo ($v['id']); ?>"><?php echo ($v['activename']); ?></option>
                                <?php endforeach;?>
                            </select>
                            <span2 id='sp6'></span2>
                        </td>
...
<script type="text/javascript">
    $('.ajax-post').click(function(){
        ...
        $.ajax({
            url: "/activity_manage/Public/index.php/Admin/Notice/capital.html?id=20",
            type: "POST",
            data:{
                "activeid":s1,
                "goodsname" : s2,
            ...
            success: function(data){
                alert(data.info);
                //alert(data.id);
                window.location.href='/activity_manage/Public/index.php/Admin/Notice/sumconst';
            }
        });
    })
</script>
