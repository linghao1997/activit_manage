...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/applyback/newApply"> &nbsp;申请回复</a><span>|</span><a href="/index.php/admin/applyback/editUnit?id=38" class="current"> 申请处理</a> </div>
        <h1>申请 处理</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
 ...
 if($data[0]['level']==0){ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; }elseif($data[0]['level']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($data[0]['level']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?></td>
                    ...
                    <form method="post" action="/index.php/admin/applyback/editUnit?id=38">
                    <tr>
