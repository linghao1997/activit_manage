...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Menu/search?searchname=test"> &nbsp;搜索</a><span>|</span><a href="/index.php/Admin/Menu/search?searchname=test" class="current"> 搜索结果</a> </div>
        <h1>后台 搜索结果</h1>
    </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <form class="form-horizontal" role="form" action="/index.php/Admin/Menu/bdel" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/index.php/Admin/Menu/edit?id=<?php echo $v['id'];?>"><span>详&nbsp;情</span></a>&nbsp;&nbsp;
