...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/teacher/changeData"> 教师平台</a><span>|</span><a href="/index.php/Admin/Teacher/usedActivity" class="current"> 查看参与的活动</a> </div>
        <h1>教师平台 查看参与活动</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
