...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Demo/demoLst"> &nbsp;成功案例</a><span>|</span><a href="/index.php/Admin/Demo/edit?id=14" class="current"> 处理案例</a> </div>
        <h1>处理 案例</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
        span2 {font-size: 18px; display : inline}
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                        <form class="form-horizontal" role="form" enctype="multipart/form-data" action="/index.php/Admin/Demo/edit" method="post">
                        <tr>
                            <td style="text-align: center;width: 15%;">
                                <span3>案例名称:&nbsp;&nbsp;</span3>
                            </td><td>
                            <input type="hidden" name="id" value="<?php echo ($content[0]['id']); ?>">
                            <input type="text" class="form-control col-md-9" id="exampleInputext1" name="demoname" onchange="return nname()" value="<?php echo ($content[0]['demoname']); ?>">
                                <span4 id="s40"></span4>
                            </td>
                        </tr>
                            <tr>
                                ...
                                <span4 id="s4"></span4>
                                <span2><a href="/Public/<?php echo ($content[0]['pic']); ?>">查看原图</a></span2>&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            </tr>
                        <tr>
                            <td style="width: 15%;text-align: center;">
                                ...
                                <input type="file" name="pic" class="form-control col-md-9" id="exampleInputext2" value="<?php echo ($content[0]['pic']); ?>" placeholder="修改效果图" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="width: 15%;text-align: center;">
                                ...
                                <img src="/Public/<?php echo ($content[0]['thumb']); ?>"/>
                            </td>
                         </tr>
                        <tr>
                            <td style="width: 15%;text-align: center;">
                        ...
                        <tr>
                            ...
                            <textarea type="text" class="form-control col-md-9" name="demoinfo" row="6" id="exampleInputext3" placeholder="案例简介" ><?php echo ($content[0]['demoinfo']); ?></textarea>
                            ...
                            <tr>
                                ...
                                <input type="radio" class="form-control col-md-9" name="classifyId[]" id="checkbox" checked value="<?php echo ($content[0]['classifyid']); ?>"/><span3>&nbsp;<?php echo ($content[0]['classifyname']); ?>&nbsp;&nbsp;&nbsp;&nbsp;</span3>
                            </td>
                            </tr>
                        <tr>
                            <td style="width: 15%;text-align: center;">
                                <span3>选择案例分类<?php echo ($content['classifyid']); ?>:&nbsp;&nbsp;</span3>
                            </td>
                            <td>

                                <?php foreach($data as $k=>$v):?>

                                <input type="radio" class="form-control col-md-9" name="classifyId[]" id="checkbox" value="<?php echo ($v['id']); ?>"/><span3>&nbsp;<?php echo ($v['classifyname']); ?>&nbsp;&nbsp;|&nbsp;&nbsp;</span3>
                                <?php endforeach;?>
                            </td>
                        </tr>
                        <tr>
