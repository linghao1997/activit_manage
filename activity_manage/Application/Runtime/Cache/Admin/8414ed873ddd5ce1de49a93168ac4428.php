...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Student/changeData"> &nbsp;学生平台</a><span>|</span><a href="/index.php/Admin/Student/search?searchname=%E6%B4%BB%E5%8A%A8" class="current"> 搜索评论</a> </div>
        <h1>学生平台 搜索评论</h1>
        <div id="search">
            <form class="form-horizontal" role="form" action="/index.php/Admin/Student/search" method="get">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <form class="form-horizontal" role="form" action="/index.php/Admin/Student/bdel" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return confirm('是否确认删除')" href="/index.php/Admin/Student/del?id=<?php echo $v['id'];?>"><span>删除&nbsp;评论</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
