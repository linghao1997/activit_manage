...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Activity/activityData"> 举办活动</a><span>|</span><a href="/index.php/Admin/Activity/show?id=6" class="current"> 上传活动总结</a> </div>
        <h1>上传  活动  总结</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:20%;">活动总结:</td>
                        <td><?php echo html_entity_decode($data[0]['summary']);?></td>
                    </tr>                
