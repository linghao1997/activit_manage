...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Applyback/newApply"> &nbsp;申请回复</a><span>|</span><a href="/index.php/Admin/Applyback/newApply" class="current"> 未处理申请</a> </div>
        <h1>未处理申请</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
        span3 {font-size: 18px;color: black; display : inline}
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <td style="background-color: #EEEEEE; border: 0pxlevel" colspan="1"></td>
                </tr>
                <tbody>
                <tr>
                    <thead>
 ...
 if($v['status']==0){ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; }elseif($v['status']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['status']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?>
                            ...
                            <td>
                                <a href="/index.php/Admin/Applyback/editApply?id=<?php echo $v['id'];?>"><span>处&nbsp;&nbsp;&nbsp;理</span></a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    <?php endforeach;?>
 ...
 if($v['level']==0){ echo "<span><i class='icon-eye-close'></i> 申请尚未处理</span>"; }elseif($v['level']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['level']==1){ echo "<span><i class='icon-ok'></i> 申请通过,社团成立</span>"; } ?>
                            ...
                            <td><?php echo ($v['createtime']); ?></td>
                            <td>
                                <a href="/index.php/Admin/Applyback/editUnit?id=<?php echo $v['id'];?>"><span>处&nbsp;&nbsp;&nbsp;理</span></a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    <?php endforeach;?>
