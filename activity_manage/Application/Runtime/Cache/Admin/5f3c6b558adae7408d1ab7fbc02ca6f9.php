...
<body>
    ...
    <script src="/Public/js/Mainjs/excanvas.min./Public/js/Mainjs/"></script> 
    <script src="/Public/js/Mainjs/jquery.min./Public/js/Mainjs/"></script> 
    <script src="/Public/js/Mainjs/jquery.ui.custom./Public/js/Mainjs/"></script> 
    <script src="/Public/js/Mainjs/bootstrap.min./Public/js/Mainjs/"></script> 
    <script src="/Public/js/Mainjs/nicescroll/jquery.nicescroll.min./Public/js/Mainjs/"></script> 
    <script src="/Public/js/Mainjs//matrix./Public/js/Mainjs/"></script> 
