...
/*        span3 {font-size: 15px;color: #666666; display : inline}
 ...
 if($v['moneystatus']== 1){ echo "<span> 未支付</span>"; }elseif($v['moneystatus']== 0){ echo "<span> 已支付</span>"; } ?>
                    ...
                    <td> <?php
 if($v['userstatus'] == 1 ){ echo "<a href=\"/activity_manage/Public/index.php/Admin/Manager/qiandao?id=".$v['id']."\"  onclick=\"return confirm('是否签到')\">签到</a>"; }else{ echo '&nbsp;'; } ?>
                    </td>
                    <td>
                        <?php
 if($v['moneystatus'] == 1 ){ echo "<a href=\"/activity_manage/Public/index.php/Admin/Manager/zhifu?id=".$v['id']."\"  onclick=\"return confirm('是否支付')\">支付</a>"; }else{ echo '&nbsp;'; } ?>
                    </td>
                </tr>
                <?php endforeach;?>
                </tbody>
