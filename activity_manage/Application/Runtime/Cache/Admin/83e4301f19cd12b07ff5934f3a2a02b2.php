...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/studentWeb-master/Public/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/studentWeb-master/Public/index.php/Admin/Menu/edit?id=14" class="current"> 留言处理</a> </div>
        <h1>后台 留言处理</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($data['contactway']); ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">联系项目类型:</td>
                        <td><?php echo ($data['subject']); ?></td>
                    </tr>
                    <tr>
                        <td style="width:20%;">联系项目简介:</td>
