...
<div id="content">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        ...
        <form class="form-horizontal" role="form" action="/studentWeb-master/Public/index.php/Admin/Activity/activitySummary" method="post">
                ...
                <tr>
                    ...
                    <?php foreach($data as $k=>$v):?> 
                        <tr>
                            ...
                            <td><img src="/studentWeb-master/Public/Public/<?php echo ($v['thumb']); ?>"/></td>
                            <td><?php echo ($v['classifyname']); ?></td>
                            <td><?php echo ($v['createtime']); ?></td>
                            <td>
                            <?php
 if($v['issummary']== 1){ echo "<span><i class='icon-lock'></i> 总结已上传</span><br>
                                    <a href=\"/studentWeb-master/Public/index.php/Admin/Activity/show?id=".$v['id']."\">查看  总结</a>"; }elseif($v['issummary']== 0){ echo "<a href=\"/studentWeb-master/Public/index.php/Admin/Activity/edit?id=".$v['id']."\">提交  总结</a>"; } ?>
                            </td>
                        </tr>
                    <?php endforeach;?>
...
<script type="text/javascript" src="/studentWeb-master/Public/Public/jS/jquery-2.1.1.min.js"></script>
