...
<div id="loginbox" class="login" value="2">
    ...
    <form id="loginform" class="form-vertical" action="/index.php/Admin/Login/login" method="post" style="display: block;">
        ...
        <div class="control-group3">
            ...
            <div class="controls">
                <div class="main_input_box">
                    ...
                    <img onclick="this.src='/index.php/Admin/Login/authCode/'+Math.random();" style="cursor:pointer;" src="/index.php/Admin/Login/authCode"/>
                </div>
            </div>
        </div><br><br>
