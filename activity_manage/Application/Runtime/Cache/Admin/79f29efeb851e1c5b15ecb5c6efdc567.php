    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 400px;">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 0">
                    ...
                    <tbody>
                        <form class="form-horizontal" role="form" action="/activity_manage/Public/index.php/Admin/User/changeData" method="post">

                        <tr>
                            <td style="text-align: center;width: 15%;">
                                <span3>员工名:&nbsp;&nbsp;</span3>
                            </td><td>
                            <input type="text" class="form-control col-md-9" name="username" id="cg2" onchange="return c2()" value="<?php echo ($data['username']); ?>" placeholder="员工名" disabled>
                                <span2 id="sp2"></span2>
                            </td>
                        </tr>
                        <tr>
