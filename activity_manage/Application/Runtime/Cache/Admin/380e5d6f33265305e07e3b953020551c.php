...
&lt;!&ndash;个人资料&ndash;&gt;
<!DOCTYPE html>
&lt;!&ndash; saved from url=(0046)/ &ndash;&gt;
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>后台管理平台</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" type="text/css" href="/studentWeb-master/Public/Public/js/jquery.datetimepicker.css"/>
</head>
<body>
&lt;!&ndash;主体部分&ndash;&gt;
<div id="content">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 400px;">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 0">
                    ...
                    <tbody>
                        <form class="form-horizontal" role="form" action="/studentWeb-master/Public/index.php/Admin/Activity/activityData" method="post" ENCTYPE="multipart/form-data">
                        <tr>
...
&lt;!&ndash;end-main-container-part&ndash;&gt;
...
<script src="/studentWeb-master/Public/Public/js/Mainjs/jquery.min.js"></script>
<script src="/studentWeb-master/Public/Public/js/Mainjs/jquery.min.js"></script>
<script src="/studentWeb-master/Public/Public/js/jquery.js"></script>
<script src="/studentWeb-master/Public/Public/js/jquery.datetimepicker.js"></script>
<script>
$('#datetimepicker').datetimepicker();
$('#datetimepicker').datetimepicker({value:'2017-08-01 07:00',step:10});
$('#enddatetime').datetimepicker();
$('#enddatetime').datetimepicker({value:'2017-08-05 09:00',step:10});
</script>
<script type="text/javascript" src="/studentWeb-master/Public/Public/js/laydate.dev.js"></script>
<script>
    function c1(){
        $('#status').val('0');
        if ($('#s1').val()=='') {
