            ...
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th style="text-align: left;" colspan="7">
                        ...
                        <span>已处理留言</span>
                        <span style="float: right;"><a href="/studentWeb-master/Public/index.php/Admin/Menu/newMessage">
                ...
                <form class="form-horizontal" role="form" action="/studentWeb-master/Public/index.php/Admin/Menu/bdel" method="post">
                     <?php foreach($data as $k=>$v):?>
                    <tr>
                        <td>
                            <input class="delids checkbox" type="checkbox" name="dbelid[]" value="<?php echo $v['id'];?>">
                        </td>
                        ...
                        <td>
                            <a href="/studentWeb-master/Public/index.php/Admin/Menu/edit?id=<?php echo $v['id'];?>"><span>详&nbsp;情</span></a>&nbsp;&nbsp;
                            <a onclick="return confirm('是否确认删除')" href="/studentWeb-master/Public/index.php/Admin/Menu/del?id=<?php echo $v['id'];?>"><span>删&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
