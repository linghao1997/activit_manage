...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Demo/demoLst"> &nbsp;成功案例</a><span>|</span><a href="/index.php/Admin/Demo/demoLst?&page=2" class="current"> 案例列表</a> </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <th colspan="6" style="text-align: left;">
                    ...
                    <span>案例列表</span>
                    <span style="float: right;"><a href="/index.php/Admin/Demo/addDemo">
