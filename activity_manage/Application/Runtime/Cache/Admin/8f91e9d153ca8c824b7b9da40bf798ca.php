...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Teacher/changeData"> 教师平台</a><span>|</span><a href="/index.php/Admin/Teacher/pifu" class="current"> 活动批复</a> </div>
        <h1>活动  批复</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
 ...
 if($v['isapproval']==0){ if($v['status']==-1){ echo "<span><i class='icon-save'></i> 活动未申请</span>";}else{ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; } }elseif($v['isapproval']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['isapproval']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?>
                            ...
                            <td>
                                <a  href='/index.php/Admin/Teacher/unitA?id=<?php echo ($v['id']); ?>'>活动 处理</a><br><br>
                                <?php
 if($v['isapproval'] !=1 ){ echo "<a onclick=\"return confirm('是否确认删除')\" href='/index.php/Admin/Manager/delA?id=".$v['id']."'>删 除</a>"; }else{ echo '&nbsp;'; } ?>
                            </td>
                        </tr>
                    <?php endforeach;?>
