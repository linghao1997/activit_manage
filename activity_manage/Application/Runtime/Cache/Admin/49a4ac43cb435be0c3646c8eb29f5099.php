        ...
        <ul class="nav" style="width: auto; margin: 0px;">
            <li class="dropdown" id="profile-messages">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="/index.php/Admin/Menu/layout"><i class="icon-key"></i> 退出系统</a></li>
                </ul>
            </li>
            ...
            <li class=""><a title="layout" href="/index.php/Admin/Menu/layout"><i class="icon icon-share-alt"></i> <span class="text">&nbsp;退出系统</span></a></li>
        </ul>
    </div>
...
<body style="height: 437px;">
    ...
    <div id="content">
        ...
        <div id="content-header">
          <div id="breadcrumb"> <a href="/index.php/Admin/Menu/addAdmin" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a></div>
        </div>
        <!--End-breadcrumbs-->
        <!--<iframe src=" " id="iframe-main" frameborder="0" style="width: 100%; height: 427px;">-->
            <!--各单位注意这里是首页-->
        <!--</iframe>-->
        <h3>
            <h3>各单位注意这里是首页</h3>
