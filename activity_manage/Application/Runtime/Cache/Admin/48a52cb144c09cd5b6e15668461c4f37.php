            ...
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th style="text-align: left;" colspan="7">
                        ...
                        <span>未处理留言</span>
                        <span style="float: right;"><a href="/activity_manage/Public/index.php/Admin/Menu/newMessage">
                ...
                <tbody>
                <form class="form-horizontal" role="form" action="/activity_manage/Public/index.php/Admin/Menu/bdel" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/activity_manage/Public/index.php/Admin/Menu/edit?id=<?php echo $v['id'];?>"><span>处&nbsp;理</span></a>&nbsp;&nbsp;
                            <a onclick="return confirm('是否确认删除')" href="/activity_manage/Public/index.php/Admin/Menu/del?id=<?php echo $v['id'];?>"><span>删&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
