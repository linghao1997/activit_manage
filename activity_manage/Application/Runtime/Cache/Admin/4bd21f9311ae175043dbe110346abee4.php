...
<div id="content">
                ...
                <tr>
                    ...
                    <?php foreach($data2 as $k=>$v):?>
                        <tr>
                            ...
                            <td><img src="/studentWeb-master/Public/Public/<?php echo ($v['adminpicthumb']); ?>"/></td>
 ...
 if($v['status']==0){ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; }elseif($v['status']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['status']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?>
                            ...
                            <td>
                                <a href="/studentWeb-master/Public/index.php/Admin/Applyback/editApply?id=<?php echo $v['id'];?>"><span>查&nbsp;&nbsp;&nbsp;看</span></a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    <?php endforeach;?>
                ...
                <tr>
                    ...
                    <?php foreach($data1 as $k=>$v):?>
                        <tr>
                            <td><?php echo ($v['num']); ?></td>
                            <td><?php echo ($v['username']); ?></td>
                            <td><img src="/studentWeb-master/Public/Public/<?php echo ($v['peoplethumb']); ?>"/></td>
                            <td><?php echo ($v['contactway']); ?></td>
                            <td><?php echo ($v['unitname']); ?></td>
                            <td><?php echo ($v['unitinfo']); ?></td>
                            <td><a href="/studentWeb-master/Public/Public/<?php echo ($v['cehua']); ?>"><?php echo ($v['cehuaname']); ?></a></td>
                            <td>
                            <?php
 if($v['level']==0){ echo "<span><i class='icon-eye-close'></i> 申请尚未处理</span>"; }elseif($v['level']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['level']== 1){ echo "<span><i class='icon-ok'></i> 申请通过,社团成立</span>"; } ?>
                            ...
                            <td><?php echo ($v['createtime']); ?></td>
                            <td>
                                <a href="/studentWeb-master/Public/index.php/Admin/Applyback/editUnit?id=<?php echo $v['id'];?>"><span>查&nbsp;&nbsp;&nbsp;看</span></a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    <?php endforeach;?>
