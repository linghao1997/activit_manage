        ...
        <ul>
            ...
            <?php if(is_array($menuList)): $i = 0; $__LIST__ = $menuList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="submenu" onclick="dj(this)">
                    ...
                    <ul>
                        ...
                        <li><a class="menu_a" id="<?php echo $v?>" href="<?php echo $v;?>"><i class="icon icon-caret-right"></i><?php echo $k; echo "&nbsp;&nbsp;&nbsp;<span class='label label-important'></span>"; ?></a></li>
                        <?php endforeach;?>
