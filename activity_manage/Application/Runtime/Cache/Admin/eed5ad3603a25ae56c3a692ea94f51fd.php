...
<div id="content">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <?php
 if($v['userstatus']== 1){ echo "<span> 未签到</span>"; }elseif($v['userstatus']== 0){ echo "<span> 已签到</span>"; } ?>
 ...
 if($v['moneystatus']== 1){ echo "<span> 未支付</span>"; }elseif($v['moneystatus']== 0){ echo "<span> 已支付</span>"; } ?>
                    ...
                    <td> <?php
 if($v['userstatus'] == 1 ){ echo "<a href=\"/activity_manage/Public/index.php/Admin/Manager/qiandao?id=$id&uid=".$v['id']."\"  onclick=\"return confirm('是否签到')\">签到</a>"; }else{ echo "<a href=\"/activity_manage/Public/index.php/Admin/Manager/cancelqiandao?id=$id&uid=".$v['id']."\"  onclick=\"return confirm('是否取消签到')\">取消签到</a>"; } ?>
                    </td>
                    <td>
                        <?php
 if($v['moneystatus'] == 1 ){ echo "<a href=\"/activity_manage/Public/index.php/Admin/Manager/zhifu?id=$id&uid=".$v['id']."\"  onclick=\"return confirm('是否支付')\">支付</a>"; }else{ echo "<a href=\"/activity_manage/Public/index.php/Admin/Manager/cancelzhifu?id=$id&uid=".$v['id']."\"  onclick=\"return confirm('是否取消支付')\">取消支付</a>"; } ?>
                    </td>
                </tr>
                <?php endforeach;?>
                </tbody>
