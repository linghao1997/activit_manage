...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/teacher/changeData"> &nbsp;教师平台</a><span>|</span><a href="/index.php/Admin/Teacher/usedComment" class="current"> 查看评论</a> </div>
        <h1>教师平台 查看评论</h1>
        <div id="search">
            <form class="form-horizontal" role="form" action="/index.php/admin/teacher/search" method="get">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <form class="form-horizontal" role="form" action="/index.php/admin/teacher/bdel" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return confirm('是否确认删除')" href="/index.php/admin/teacher/del?id=<?php echo $v['id'];?>"><span>删除&nbsp;评论</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
