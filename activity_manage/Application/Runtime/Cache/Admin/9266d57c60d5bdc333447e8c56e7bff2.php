...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/applyback/newApply"> &nbsp;申请回复</a><span>|</span><a href="/index.php/Admin/Applyback/handleApply" class="current"> 已处理申请</a> </div>
        <h1>已处理申请</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
 ...
 if($v['status']==0){ echo "<span><i class='icon-eye-close'></i> 申请未处理</span>"; }elseif($v['status']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['status']==1){ echo "<span><i class='icon-ok'></i> 申请已通过</span>"; } ?>
                            ...
                            <td>
                                <a href="/index.php/admin/applyback/editApply?id=<?php echo $v['id'];?>"><span>查&nbsp;&nbsp;&nbsp;看</span></a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    <?php endforeach;?>
 ...
 if($v['level']==0){ echo "<span><i class='icon-eye-close'></i> 申请尚未处理</span>"; }elseif($v['level']==-1){ echo "<span><i class='icon-remove'></i> 申请未通过</span>"; }elseif($v['level']== 1){ echo "<span><i class='icon-ok'></i> 申请通过,社团成立</span>"; } ?>
                            ...
                            <td><?php echo ($v['createtime']); ?></td>
                            <td>
                                <a href="/index.php/admin/applyback/editUnit?id=<?php echo $v['id'];?>"><span>查&nbsp;&nbsp;&nbsp;看</span></a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    <?php endforeach;?>
