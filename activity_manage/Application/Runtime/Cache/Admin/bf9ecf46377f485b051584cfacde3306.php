...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/admin/teacher/changeData"> 教师平台</a><span>|</span><a href="/index.php/Admin/Teacher/unitA?id=12" class="current"> 活动处理</a> </div>
        <h1>活动  处理</h1>
    </div>    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 400px;">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 0">
                    ...
                    <tbody>
                        <form class="form-horizontal" role="form" action="/index.php/Admin/Teacher/unitA?id=12" method="post" ENCTYPE="multipart/form-data">
                        <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td><a href="/Public/<?php echo ($data[0]['pic']); ?>" target="_blank"><img src="/Public/<?php echo ($data[0]['thumb']); ?>"></a>
                            </td>
                        </tr>
                        <tr>
