...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Apply/myClassify"> &nbsp;案例分类</a><span>|</span><a href="/index.php/Admin/Apply/myClassify"> &nbsp;分类处理</a><span>|</span><a href="/index.php/Admin/Apply/edit" class="current"> 修改分类</a> </div>
        <h1>修改 分类</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 0">
                    ...
                    <tbody>
                        <form class="form-horizontal" role="form" action="/index.php/Admin/Apply/edit" method="post">
                        <tr>
