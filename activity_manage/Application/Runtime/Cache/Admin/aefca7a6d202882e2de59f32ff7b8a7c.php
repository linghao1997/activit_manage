            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span><?php echo $v['holdtime'];?></span></td>
                        </td>
                        <td>
                            <span>
                                <?php if($v['level']==1){ echo "学生社团"; }elseif($v['level']==2){ echo "学校组织"; }?>
                            </span>
                        </td>
                        <td>
                            <a href="/studentWeb-master/Public/index.php/Admin/Teacher/unitedit?id=<?php echo $v['id'];?>"><span>详&nbsp;情</span></a>&nbsp;&nbsp;
                            <a onclick="return confirm('是否确认删除')" href="/studentWeb-master/Public/index.php/Admin/Teacher/del?id=<?php echo $v['id'];?>"><span>删&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
