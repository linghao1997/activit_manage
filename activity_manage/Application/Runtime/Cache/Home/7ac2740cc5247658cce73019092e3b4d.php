...
<div class="main_bg">
	<div class="container">
		<div class="main_grid1">
			<h3 class="style pull-left">已结束活动</h3>
			<div class="clearfix"></div>
		</div>
	</div>
</div>
			...
			<div class="about-desc">
				...
				<div class="active_w cf">
					<div class="active_img2 fl">
						<a href='activeDetails.html?id=<?php echo ($v["id"]); ?>&status=<?php echo ($v["status"]); ?>'><img src="/activity_manage/Public/Public/<?php echo ($v['pic']); ?>" width="100%" height="100%"></a>
					</div>
					<div class="active_info fl">
						<ul>
							<li><a href='activeDetails.html?id=<?php echo ($v["id"]); ?>&status=<?php echo ($v["status"]); ?>'>活动名称: <?php echo $v['activename'];?></a></li>
