...
<head>
    ...
    <meta name="keywords" content="Skate Responsive web template, Bootstrap Web Templates" />
...
<div class="main_bg">
    <div class="container">
        <div class="main_grid1">
            <h3 class="style pull-left">活动详情</h3>
            <div class="clearfix"></div>
        </div>
    </div>
</div>
        ...
        <div class="about">
            <div class="about-desc">
                ...
                <div class="active_w cf">
                    ...
                    <img src="/activity_manage/Public/Public/<?php echo ($v['pic']); ?>" width="100%" height="100%">
                    </div>
                    <div class="active_info fl">
                        <ul>
                            <li>活动名称: <?php echo $v['activename'];?></li>
                ...
                <div>
                    ...
                    <p class="active_intro">
                       <?php echo $v['activeinfo'] ?>
                    </p>
                </div>
                <div>
                    <h3>活动详情</h3>
                    <p class="active_intro">
                        <?php echo $v['activecontact'] ?>
                    </p>

                </div><br>
                <h4><a href="enter.html?id=<?php echo ($id); ?>"><?php echo ($bm); ?></a></h4>
                <?php endforeach;?>
            </div>
