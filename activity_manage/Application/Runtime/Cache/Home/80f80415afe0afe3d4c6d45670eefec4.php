...
<div class="container">
	<div class="header">
		...
		<ul class="menu list-unstyled">
			...
			<li><a href="about.html">365组织</a></li>
			<li><a href="404.html">申报活动</a></li>
			<li><a href="portfolio.html">活动进行</a></li>
			<li><a href="portfolio.html">往期活动</a></li>
            <?php
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-middle">活动申请流程</h3>
...
<div class="container">
	<div class="about">
		<div class=""style pull-middle"">
			   ...
			   <p></p>
			   <p></p>
			   <a class="btn btn1 btn3" href="/activity_manage/Public/index.php/Admin/Admin/admin">我要申请</a>    
		</div>
...
<!--<div class="col-md-4 footer_of_3">
			...
			<div class="col-xs-3 f_pic">
                     <form action="/activity_manage/Public/index.php/Home/Index/contact" method="post" role="form">
