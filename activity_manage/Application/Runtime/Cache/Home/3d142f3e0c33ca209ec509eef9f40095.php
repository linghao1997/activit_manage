            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="title text-center wow fadeInUp" data-wow-duration="500ms">
                        <h2><span class="color">我们 的 团队</span></h2>
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms">
                       <article class="team-mate">
                            <div class="member-photo">
                                <!-- member photo -->
                                <img class="img-responsive" src="/Public/images/chen.jpg" alt="Meghna">
                                <!-- /member photo -->
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="200ms">
                       <article class="team-mate">
                            <div class="member-photo">
                                <!-- member photo -->
                                <img class="img-responsive" src="/Public/images/me.jpg" alt="Meghna">
                                <!-- /member photo -->
            ...
            <div class="container">
                <div class="row wow fadeInDown" data-wow-duration="500ms">
                    ...
                    <div class="title text-center">
                        <h2><span class="color">团队  技能</span></h2>
                        <div class="border"></div>
                    </div>
                    <!-- /section title -->
